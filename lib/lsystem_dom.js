( function ( lsystem_dom )
{
    ...
    lsystem_dom.show_lsystem_menu = function ( render_data )
    {
        let content = clone_template ( "lsystem_menu_template" );
        show_ui_menu ( "lsystem_menu", "L-System", content );
        console.log ( render_data );
        populate_fields_from_render_data ( render_data );
    }

    let populate_fields_from_render_data = function ( render_data )
    {
        let start_field = document.getElementById ( "start_string_field" );
        start_string_field.value = render_data.get_start ();
    }
