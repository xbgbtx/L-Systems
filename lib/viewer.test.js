...
test ( "display func calls interpreter funcs with dctx array", ()=>
{
    ...
    expect ( string_interpreter ).toHaveBeenNthCalledWith ( 1, "A" );
    expect ( string_interpreter ).toHaveBeenNthCalledWith ( 2, "AB" );
    expect ( string_interpreter ).toHaveBeenNthCalledWith ( 3, "ABC" );
});
