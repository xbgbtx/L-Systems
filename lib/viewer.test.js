...
test ( "construct a viewer", () =>
{
    ...
    v.display ( start, rewrite, string_interpreter, draw_set, succ_transform );
...
test ( "display func calls interpreter funcs with dctx array", ()=>
{
    ...
    expect ( succ_transform ).toHaveBeenNthCalledWith ( 1, d2 );
    expect ( succ_transform ).toHaveBeenNthCalledWith ( 2, d3 );
});
